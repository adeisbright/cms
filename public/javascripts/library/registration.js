...
class RegistrationController {
    ...
    handleSelect(event) {
        if (event.target.id === "stateR" || event.target.id === "companyType") {
    ...
    handleBlur(event) {
        if (event.target.id === "companyName" || event.target.id === "address" || event.target.id === "regNumber" || event.target.id === "contactName" || event.target.id === "contactRole") { 
        ...
        if (event.target.id === "mobile" || event.target.id === "contactNumber") {      
            let p = createElement("p")   
    ...
    handleSubmit(event) { 
		if (event.target.id === "submit") {     
            ...
            if(RegistrationModel.validFormValue.companyName && RegistrationModel.validFormValue.regNumber && 
                RegistrationModel.validFormValue.email  && RegistrationModel.validFormValue.mobile &&
                RegistrationModel.validFormValue.password && RegistrationModel.validFormValue.address &&
                RegistrationModel.validFormValue.contactRole && RegistrationModel.validFormValue.contactNumber &&
                RegistrationModel.validFormValue.cPass && RegistrationModel.validFormValue.stateR &&
                RegistrationModel.validFormValue.companyType){
